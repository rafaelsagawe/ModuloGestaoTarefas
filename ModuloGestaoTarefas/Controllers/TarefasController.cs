...
using ModuloGestaoTarefas.Data;
using ModuloGestaoTarefas.Models;

namespace ModuloGestaoTarefas.Controllers
{
    public class TarefasController : Controller
    {
        ...
        // Metodo de adicionar tarefa diretamente na página index
        [HttpPost]
        public async Task<IActionResult> AddTarefa(Tarefa tarefa)
        {
            if (tarefa != null)
            {
                tarefa.usuario = User.Identity.Name; // Captura o usuário logado pelo Identity
